...
class SongLibraryViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(SongLibraryCell.self, forCellReuseIdentifier: cellID)
        setupSongs()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! SongLibraryCell
