...
class WordsearchViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    func setupGridCollectionView() {
        collectionView.register(WordsearchCell.self, forCellWithReuseIdentifier: cellID)
        collectionView.register(WordsearchFooter.self, forCellWithReuseIdentifier: footerID)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.section >= wordsearch.labels.count {
            let view = collectionView.dequeueReusableCell(withReuseIdentifier: footerID, for: indexPath) as! WordsearchFooter
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! WordsearchCell
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if let cell = collectionView.cellForItem(at: indexPath) as? WordsearchCell {
